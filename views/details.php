<div class="component-body block-transparencia">
    ...
    <?php if($fraccion->aplicable): ?>
        ...
        <hr><!--Botones de EXCEL Y VER EN LINEA-->
        <?php endif;?>
        <p>&nbsp;<a target="_blank"><button type="button" class="btn btn-large btn-success"><em class="fa fa-file-excel-o"> Descargar Excel</em></button> </a> <a target="_blank"> <button type="button" class="btn btn-large btn-danger"><em class="fa fa-eye"> Ver Online</em></button> </a> <span style="padding-left: 20px;"> <span class="fa fa-hand-o-left"></span> Descargue y/o visualice aquí</span></p>
        <hr></div>
    <?php else:?>
    <div class="no-aplica">
